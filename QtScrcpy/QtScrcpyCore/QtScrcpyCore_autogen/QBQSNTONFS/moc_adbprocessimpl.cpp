...
#include "../../src/adb/adbprocessimpl.h"
...
void AdbProcessImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AdbProcessImpl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AdbProcessImpl::*)(qsc::AdbProcess::ADB_EXEC_RESULT );
...
QT_INIT_METAOBJECT const QMetaObject AdbProcessImpl::staticMetaObject = { {
    ...
    qt_meta_stringdata_AdbProcessImpl.data,
    qt_meta_data_AdbProcessImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
